...
def parse_args(default=False):
    ...
    parser.add_argument('--prompts_dir', metavar='DIR', default='',
                    help='path to dataset')
    parser.add_argument('--test_dir', metavar='DIR', default='',
                        help='path to dataset')
    ...
    parser.add_argument('--lam', type=float, default=0.5, metavar='N',
                        help="The lambda value for the adaptive MSE oss scaling (default: 1.0)")
    parser.add_argument('--language_model', type=str, default='bert', metavar='MODEL', 

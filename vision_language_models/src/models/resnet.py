...
class ResNet(nn.Module):
    def __init__(self, block, num_blocks, num_classes=1000, feature_dim=None):
        ...
        self.linear_transform = nn.Linear(512*block.expansion, feature_dim)
    ...
    def forward(self, x, is_test=True):
        out = F.relu(self.bn1(self.conv1(x)))
        ...
        vision_features = self.linear_transform(out)
        vision_outputs = self.linear(vision_features)
